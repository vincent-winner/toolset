 ...
 * @see FaceLandmark
 */
public class FaceLandmark68 extends FaceFunction {

    protected FaceLandmark68() {
        super();
    }
    ...
    protected void loadDependencies() {
        loadDependencies0(config.getFaceLandmark68());
    }
    ...
    protected void loadLibrary() {
        loadLibrary0(config.getFaceLandmark68());
    }
    ...
    protected void loadModel() {
        File modelFile = new File(config.getModelRoot(),(String) config.getFaceLandmark68().get("model"));
