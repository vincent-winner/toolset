...
public class BannerRule {
    private BannerLayout horizontalLayout;
    ...
    private BannerLayout verticalLayout;
    ...
    public BannerRule(BannerLayout horizontalLayout, boolean horizontal1, boolean horizontal2, boolean horizontal3, boolean horizontal4, boolean horizontal5, boolean horizontal6,
                      BannerLayout verticalLayout, boolean vertical1, boolean vertical2, boolean vertical3, boolean vertical4, boolean vertical5) {
    ...
    public BannerRule copy() {
        return new BannerRule(horizontalLayout, horizontal1, horizontal2, horizontal3, horizontal4, horizontal5, horizontal6,
                verticalLayout, vertical1, vertical2, vertical3, vertical4, vertical5);
    }

    public void setHorizontal(BannerLayout horizontalLayout, boolean horizontal1, boolean horizontal2, boolean horizontal3, boolean horizontal4, boolean horizontal5, boolean horizontal6) {
        this.horizontalLayout = horizontalLayout;
        this.horizontal1 = horizontal1;
        this.horizontal2 = horizontal2;
        this.horizontal3 = horizontal3;
    ...
    public void setVertical(BannerLayout verticalLayout, boolean vertical1, boolean vertical2, boolean vertical3, boolean vertical4, boolean vertical5) {
        this.verticalLayout = verticalLayout;
        this.vertical1 = vertical1;
        this.vertical2 = vertical2;
        this.vertical3 = vertical3;
    ...
    public BannerLayout getHorizontalLayout() {
        return horizontalLayout;
    }

    public void setHorizontalLayout(BannerLayout horizontalLayout) {
        this.horizontalLayout = horizontalLayout;
    }
    ...
    public BannerLayout getVerticalLayout() {
        return verticalLayout;
    }

    public void setVerticalLayout(BannerLayout verticalLayout) {
        this.verticalLayout = verticalLayout;
    }
