...
public class BannerOption {
    ...
    public BannerOption(Integer baseline, Integer codeTagCount, BannerRule rule,
    ...
    public BannerOption copy() {
        return new BannerOption(baseline, codeTagCount, rule != null ? rule.copy() : null,
